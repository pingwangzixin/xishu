...
$(function () {
    ...
    $.ajax({
        ...
        complete: function () {
            ...
            // $('.swiper-slide[data-type=1]').css('cursor', 'pointer');
...
window.onload = function () {
    ...
    // })
    // $('body').on('click', '.swiper-slide[data-type=3]', function () {
    //     // window.location.href="answer.html";
    //     window.open('https://www.cpda.cn/openclass/detail/?id=438')
    // })
    // $('body').on('click', '.swiper-slide[data-type=1]', function () {
    //     // window.location.href="answer.html";
    //     window.open('https://www.cpda.cn/association/detail/?id=446')
    // })
    // $('.swiper-slide[data-type=4]').css('cursor', 'pointer');
    // var answerHtml = `
