...
(function(factory) {
    ...
    var buttonGroup = renderer.create('<div class="note-btn-group btn-group" style="display: none;">');
    ...
    var dialog = renderer.create('<div class="modal" style="background:rgba(0,0,0,0.7)" aria-hidden="false" tabindex="-1"/>', function($node, options) {
        if (options.fade) {
            $node.addClass('fade');
        }
        $node.html([
    ...
    var ui = {
        ...
        button: function($node, options) {
            return renderer.create('<button type="button" class="note-btn btn btn-default btn-sm" style="display:none;" tabindex="-1">', function($node, options) {
